...
def supply_chain():
    ...
    copyfile(
        "functionary_carl/package.be06db20.link", "final_product/package.be06db20.link"
    )
    copyfile(
        "functionary_carl/demo-project.tar.gz", "final_product/demo-project.tar.gz"
    )
...
def main():
    ...
    parser.add_argument("-n", "--no-prompt", help="No prompt.", action="store_true")
    parser.add_argument(
        "-c", "--clean", help="Remove files created during demo.", action="store_true"
    )
